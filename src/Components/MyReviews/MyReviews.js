...
const MyReviews = () => {
  ...
  useEffect(() => {
    fetch(`https://services-server-2ip03zcd9-maruff.vercel.app/my-reviews?email=${user?.email}`, {
      headers: {
  ...
  const handleDelete = (id) => {
    fetch(`https://services-server-2ip03zcd9-maruff.vercel.app/my-reviews/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
